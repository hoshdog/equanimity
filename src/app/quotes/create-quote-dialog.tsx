// src/app/quotes/create-quote-dialog.tsx
'use client';
...
export function CreateQuoteDialog({ children, initialProjectId }: { children: React.ReactNode, initialProjectId?: string }) {
                                        ...
                                        <FormItem>
                                            ...
                                            <div className="flex gap-2">
                                                ...
                                                <AddCustomerDialog onCustomerAdded={handleCustomerAdded}>
                                                    <Button type="button" variant="outline" size="icon" className="shrink-0" disabled={!!initialProjectId}>
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <SearchableCombobox
                                                ...
                                                disabled={!watchedCustomerId || !!initialProjectId}
                                            />
                                            <FormMessage />
                                        </FormItem>
                                    )}
