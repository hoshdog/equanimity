...
export function AddressAutocompleteInput({ searchType, ...rest }: AddressAutocompleteInputProps) {
  ...
  // Extract onPlaceSelect to prevent duplicate prop warning
  const { onPlaceSelect, ...inputProps } = rest;
  
  return (
    <APIProvider apiKey={apiKey} libraries={['places']}>
      <AutocompleteInput onPlaceSelect={onPlaceSelect} searchType={searchType} {...inputProps} />
    </APIProvider>
  );
}
